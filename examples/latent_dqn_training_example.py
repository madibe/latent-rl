"""Ejemplo de entrenamiento de LatentDQNAgent.

Este ejemplo demuestra cómo entrenar un agente LatentDQN con encoder latente
en el entorno financiero. Es un ejemplo experimental y educativo, no optimizado
para producción.
"""
...
def main():
    ...
    print("=== Ejemplo de Entrenamiento LatentDQN ===\n")
    ...
    # 3. Crear agente LatentDQN
    print("3. Creando agente LatentDQN...")
    ...
    model_path = models_dir / "latent_dqn_agent.pth"
    ...
    print("\nNotas:")
    print("- Este es un agente LatentDQN experimental y educativo.")
    print("- El entrenamiento es corto (10 episodios) para demostración.")
    print("- No se afirma que LatentDQN supere a DQN, RandomAgent o BuyAndHoldAgent.")
    print("- Para resultados de producción, se requiere más entrenamiento y tuning.")
    print("- Este ejemplo sirve como base para comparar representaciones latentes vs estándar.")
